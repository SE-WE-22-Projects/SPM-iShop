                    ...
                    <Box id="modal-modal-description" sx={{ mt: 2 }}>
                        ...
                        >
                            <Stack direction="row" spacing={8}>
                                <Box>
                                    <TextField id="outlined-basic1" label="Employee Name" variant="outlined" name="name" value={name} onChange={(e) => setName(e.target.value)} />
                                </Box>
                                <Box>
                                    <TextField
                                        id="outlined-select3"
                                ...
                                <Box>
                                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                                        <DemoContainer components={['DatePicker']}>
                                            <DatePicker label="Birth Date" value={dayjs(dateOfBirth)} onChange={(val) => setDateOfBirth(val)} maxDate={dayjs()} />
                                        </DemoContainer>
                            ...
                            <Stack direction="row" spacing={8}>
                                <Box>
                                    <TextField type="number" id="outlined-basic2" label="Contact No" variant="outlined" value={contactNumber} name="contactNumber" onChange={(e) => setContactNumber(Number.parseInt(e.target.value))} />
                                </Box>
                                <Box>
                                    <TextField type="email" id="outlined-basic2" label="Email" variant="outlined" value={email} name="email" onChange={(e) => setEmail(e.target.value)} />
                                </Box>
                            </Stack>
                            <Box>
                                <TextField type="text" id="outlined-basic2" label="Address" variant="outlined" value={address} name="address" onChange={(e) => setAddress(e.target.value)} />
                            </Box>
                            <Box>
                                <LocalizationProvider dateAdapter={AdapterDayjs}>
                                    <DemoContainer components={['DatePicker']}>
                                        <DatePicker label="Hier Date" value={dayjs(hireDate)} onChange={(val) => setHireDate(val)} maxDate={dayjs()} />
                                    </DemoContainer>
                                </LocalizationProvider>
                            </Box>
                            <Box>
                                <TextField type="number" id="outlined-basic2" label="Basic Salary" variant="outlined" value={basicSalary} name="basicSalary" onChange={(e) => setBasicSalary(Number.parseInt(e.target.value))} />
                            </Box>
