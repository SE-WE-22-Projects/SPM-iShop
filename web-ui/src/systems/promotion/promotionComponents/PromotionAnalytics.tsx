    ...
    <Box>
      ...
      <Box mt={7}>
        <DynamicTable
          ...
          headers={headers}
          columns={columns}
          title="Precentage Based Promotion Details"
          filterAttribute="dis_percentage"
      ...
      <Box mt={7}>
        <DynamicTable
          ...
          headers={headers}
          columns={columns}
          title="Amount Based Promotion Details"
          filterAttribute="dis_amount"
          filterCondition={filterFunction}
        ></DynamicTable>
      </Box>
    </Box>
